...
class UHC(models.Model):
	...
	superficie_hectareas = models.DecimalField(max_digits=10, decimal_places=5)
	def parcelas_asignadas(self):
		parcelas = Parcela.objects.filter(idUHC = self.id)
		list_ids = []
...
class muestra_fenologia(models.Model):
	...
	muestra_a1 = models.IntegerField(blank=True)
	muestra_a2 = models.IntegerField(blank=True)
	muestra_a3 = models.IntegerField(blank=True)
	muestra_e1 = models.IntegerField(blank=True)
	muestra_e2 = models.IntegerField(blank=True)
	muestra_e3 = models.IntegerField(blank=True)
	muestra_f1 = models.IntegerField(blank=True)
...
class Parcela(models.Model):
	...
	sr = models.CharField(max_length=10,
                                   ...
                                   default="SECANO")
	descripcion = models.TextField()
	idUHC = models.ForeignKey(UHC, related_name ='parcelas')
	idExplotacion = models.ForeignKey(Explotacion,related_name = 'parcelasExplotacion')
	idcultivo = models.ForeignKey(Cultivoexplotacion,related_name = 'parcelasCultivo')
