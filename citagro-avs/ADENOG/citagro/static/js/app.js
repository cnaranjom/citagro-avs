(function(){
	...
	administrador.controller('AdministradorController',['$http','$log','$scope',function($http,$log,$scope){
		...
		$scope.borrarParcela = function(idPar){
			$http.delete('/api/parcelas/'+idPar).
				success(function(data,status,headers,config){
					var index = 0;
		...
		$scope.guardarParcela = function(idexp,idUHC,idCul){
			if(idCul == ''){
				alert("tiene que seleccionar u cultivo para guardar una parcela")
			}else{
			poli = $scope.poligono;
			parce = $scope.parcela;
			recin = $scope.recinto;
...
administrador.controller('creaMuestra',['$http','$log','$scope',function($http,$log,$scope){
	...
	var arrayFenologia = [{letra: "A", texto: "Flor marculina: Receso", tipo: "fenologia", valor: "0"}]
	arrayFenologia.push({letra: "B", texto: "Flor marculina: Inicio de elongación", tipo: "fenologia", valor: "0"})
	arrayFenologia.push({letra: "C", texto: "Flor marculina: Inicio apertura amentos", tipo: "fenologia", valor: "0"})
	arrayFenologia.push({letra: "D", texto: "Flor marculina: Inicio emisión de polen", tipo: "fenologia", valor: "0"})
	arrayFenologia.push({letra: "E", texto: "Flor marculina: Plena emisión de polen", tipo: "fenologia", valor: "0"})
	arrayFenologia.push({letra: "F", texto: "Flor marculina: Término emisión de polen", tipo: "fenologia", valor: "0"});
    arrayFenologia.push({letra: "A1", texto: "Flor femenina: Receso", tipo: "fenologia", valor: "0"});
    arrayFenologia.push({letra: "A2", texto: "Flor femenina: Inicio de brotación", tipo: "fenologia", valor: "0"});
    arrayFenologia.push({letra: "A3", texto: "Flor femenina: Hojas en expansión", tipo: "fenologia", valor: "0"});
    arrayFenologia.push({letra: "E1", texto: "Flor femenina: Flor pistilada/pre-receptiva", tipo: "fenologia", valor: "0"});
    arrayFenologia.push({letra: "E2", texto: "Flor femenina: Flor pistilada receptiva", tipo: "fenologia", valor: "0"});
    arrayFenologia.push({letra: "E3", texto: "Flor femenina: Flor pistilada/post-receptiva", tipo: "fenologia", valor: "0"});
	arrayFenologia.push({letra: "F1", texto: "Flor femenina: Fruto pequeño", tipo: "fenologia", valor: "0"});
	
	var arrayInsectos = [{letra: "1", texto: "Coccinélidos: % brotes con presencia", tipo: "insectos", valor: "0"}]
	arrayInsectos.push({letra: "2", texto: "Neurópteros: % brotes con presencia", tipo: "insectos", valor: "0"})
	arrayInsectos.push({letra: "3", texto: "Sirfidos: % brotes con presencia", tipo: "insectos", valor: "0"})
	arrayInsectos.push({letra: "4", texto: "Fitoseidos: % brotes con presencia", tipo: "insectos", valor: "0"})
	arrayInsectos.push({letra: "5", texto: "Scutellista: % brotes con presencia", tipo: "insectos", valor: "0"})
	arrayInsectos.push({letra: "6", texto: "Apanteles: % de parasitismo", tipo: "insectos", valor: "0"})
	arrayInsectos.push({letra: "7", texto: "Aphytis: % de parasitismo", tipo: "insectos", valor: "0"})
	
	var arrayTrampas = [{letra: "M", texto: "Carpocapsa (nº adultos/trampa y día)", tipo: "trampas", valor: "0"}]
	
	var arrayBrotes = [{letra: "8", texto: "Carpocapsa o gusano de la nuez: % frutos atacados", tipo: "brotes", valor: "0"}]
	arrayBrotes.push({letra: "9", texto: "Ácaros: % brotes atacados", tipo: "brotes", valor: "0"})
	arrayBrotes.push({letra: "10", texto: "Pulgones: % brotes atacados", tipo: "brotes", valor: "0"})
	
	var arrayZeuzera = [{letra: "11", texto: "Barrinador de la madera (Zeuzera pyrina): brotes afectados", tipo: "zeuzera", valor: "0"}]
	
	var arrayEnfermedades = [{letra: "12", texto: "Bacteriosis: % brotes atacados", tipo: "enfermedades", valor: "0"}]
	arrayEnfermedades.push({letra: "13", texto: "Antracnosis: % brotes atacados", tipo: "enfermedades", valor: "0"})
	...
	$scope.arrayBrotes = arrayBrotes;
	$scope.arrayZeuzera = arrayZeuzera;
	...
	$scope.iniciaMuestra = function(idMuestra){
		...
		$http.get('/api/muestras/'+idMuestra).success(function(data){
			...
			if(data.fenologia.length > 0){
				...
				document.getElementById("A1").selectedIndex = data.fenologia[0].muestra_a1;
				document.getElementById("A2").selectedIndex = data.fenologia[0].muestra_a2;
				document.getElementById("A3").selectedIndex = data.fenologia[0].muestra_a3;
				document.getElementById("E1").selectedIndex = data.fenologia[0].muestra_e1;
				document.getElementById("E2").selectedIndex = data.fenologia[0].muestra_e2;
				document.getElementById("E3").selectedIndex = data.fenologia[0].muestra_e3;
				document.getElementById("F1").selectedIndex = data.fenologia[0].muestra_f1;
				fen = data.fenologia[0].id;
			}
			if(data.trampas.length > 0){
				$log.log("trampas")
				document.getElementById("M").value = data.trampas[0].carpocapsa;
			...
			if(data.insectos.length > 0){
				...
				document.getElementById("3").value = data.insectos[0].sirfidos;
				document.getElementById("4").value = data.insectos[0].fitoseidos;
				document.getElementById("5").value = data.insectos[0].scutellista;
				document.getElementById("6").value = data.insectos[0].apanteles;
				document.getElementById("7").value = data.insectos[0].aphytis;
				insc = data.insectos[0].id;
			}
			if(data.brotes.length > 0){
				$log.log("brotes")
				document.getElementById("8").value = data.brotes[0].carpocapsa;
				document.getElementById("9").value = data.brotes[0].acaros
				document.getElementById("10").value = data.brotes[0].pulgones;
				brt = data.brotes[0].id;
			}
			if(data.zeuzera.length > 0){
				$log.log("zeuzera")
				document.getElementById("11").value = data.zeuzera[0].zeuzera;
				zeuz = data.zeuzera[0].id;
			}
	...
	$scope.modificaMuestra = function(expid,tecid,muestraId){
			...
			arrayFen = ["A","B","C","D","E","F","A1","A2","A3","E1","E2","E3","F1"];
			arrayIns = ["1","2","3","4","5","6","7"];
			arrayTmp = ["M"];
			arrayBrt = ["8","9","10"]
			arrayZeuz = ["11"]
			arrayEnf = ["12","13"]
			arrayId = arrayFen.concat(arrayTmp).concat(arrayIns).concat(arrayBrt).concat(arrayZeuz).concat(arrayEnf);
			modificaMuestras = [];
			...
			success(function(data,status,headers,config){
				...
				for(i=0; i< modificaMuestras.length; i++){
					...
					}else if(modificaMuestras[i] == "brot"){
						val = [];
						for (j= 0; j<arrayBrt.length; j++){
							val[j]=document.getElementById(arrayBrt[j]).value;	
							if(val[j] == ""){
								val[j] = 0;
							}
						}
					
						brotes = {idMuestra: data.id,carpocapsa: val[0],acaros: val[1],pulgones: val[2]};
						if(brt == 0){
							$http.post('/api/muestras/brotes/',brotes).
							success(function(data,status,headers,config){
								fallo = false && fallo;
							}).error(function(data,status,headers,config){
								fallo = true && fallo;
							...
							$http.put('/api/muestras/brotes/'+brt,brotes).
							success(function(data,status,headers,config){
								fallo = false && fallo;
							}).error(function(data,status,headers,config){
								fallo = true && fallo;
					...
					}else if(modificaMuestras[i] == "zeuz"){
						val = [];
						for (j= 0; j<arrayZeuz.length; j++){
							val[j]=document.getElementById(arrayZeuz[j]).value;	
							if(val[j] == ""){
								val[j] = 0;
							}
						}
					
						zeuzera = {idMuestra: data.id,zeuzera: val[0]};
						if(zeuz == 0){
							$http.post('/api/muestras/zeuzera/',zeuzera).
							success(function(data,status,headers,config){
								fallo = false && fallo;
							}).error(function(data,status,headers,config){
								fallo = true && fallo;
							...
							$http.put('/api/muestras/zeuzera/'+zeuz,zeuzera).
							success(function(data,status,headers,config){
								fallo = false && fallo;
							}).error(function(data,status,headers,config){
								fallo = true && fallo;
				...
				if(brt > 0){
					if(modificaMuestras.indexOf("brot") == -1){
						$http.delete('/api/muestras/brotes/'+brt);
					}
				}
				if(zeuz > 0){
					if(modificaMuestras.indexOf("zeuz") == -1){
						$http.delete('/api/muestras/zeuzera/'+zeuz);
					}
				}
				if(enf > 0){
					if(modificaMuestras.indexOf("enfe") == -1){
	...
	$scope.guardarMuestra = function(expid,tecid,tipoUs){
			...
			for(i = 0; i < arrayId.length; i++){
				if(arrayFen.indexOf(arrayId[i]) != -1){
					...
					value = parseInt(document.getElementById(arrayId[i]).value);
					if(value > 0 && modificaMuestras.indexOf("brot")){
						modificaMuestras.push("brot")
					}	
				}else if (arrayZeuz.indexOf(arrayId[i]) != -1){
					value = parseInt(document.getElementById(arrayId[i]).value);
					if(value > 0 && modificaMuestras.indexOf("zeuz")){
						modificaMuestras.push("zeuz")
					}	
				}else if (arrayEnf.indexOf(arrayId[i]) != -1){
					value = parseInt(document.getElementById(arrayId[i]).value);
	...
	$scope.fenologia = function(){
		...
		$scope.muestraFenologia = true;
		$scope.muestraBrotes = false;
		$scope.muestraZeuzera = false;
	...
	$scope.trampas = function(){
		...
		elementoId = "tramp";
		document.getElementById("tablaMuestras").tHead.innerHTML ="<tr><th>Trampas</th><th width='90'></th></tr>";
	};
	$scope.brotes = function(){
		$scope.muestraInsectos = false;
		$scope.muestraTrampas = false;
		$scope.muestraFenologia = false;
		$scope.muestraBrotes = true;
		$scope.muestraZeuzera = false;
		$scope.muestraEnfermedades = false;
		document.getElementById(elementoId).className ="list-group-item";
		document.getElementById("brotes").className ="list-group-item active";
		elementoId = "brotes";
		document.getElementById("tablaMuestras").tHead.innerHTML ="<tr><th>Muestreo Brotes/Frutos</th><th width='90'></th></tr>";
	};
	$scope.zeuzera = function(){
		$scope.muestraInsectos = false;
		$scope.muestraTrampas = false;
		$scope.muestraFenologia = false;
		$scope.muestraBrotes = false;
		$scope.muestraZeuzera = true;
		$scope.muestraEnfermedades = false;
		document.getElementById(elementoId).className ="list-group-item";
		document.getElementById("zeuz").className ="list-group-item active";
		elementoId = "zeuz";
		document.getElementById("tablaMuestras").tHead.innerHTML ="<tr><th>Zeuzera</th><th width='90'></th></tr>";
	};
